                ...
                return (
                  <Link 
                    ...
                    className={`group relative overflow-hidden p-5 border rounded-2xl transition-all duration-300 flex flex-col justify-center ${
                      isDisabled 
                        ? 'bg-slate-800/40 border-slate-700/50 opacity-75 cursor-not-allowed grayscale pointer-events-none'
                        : isComplete
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center mb-2 relative z-10">
                      <div className="font-bold text-lg text-slate-200 group-hover:text-cyan-400 transition-colors flex items-center gap-2">
                        {mod.name}
                        {isDisabled && <span className="text-[9px] bg-slate-800 text-slate-400 px-2 py-0.5 rounded-full uppercase tracking-widest font-bold border border-slate-600/50 shadow-inner">Off Shift</span>}
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <ChevronRight className={`w-5 h-5 ${isDisabled ? 'text-slate-600' : 'text-slate-600 group-hover:text-cyan-400 group-hover:translate-x-1'} relative z-10 transition-transform`} />
                      </div>
                    </div>
